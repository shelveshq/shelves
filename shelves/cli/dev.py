...
Usage:
  shelves-dev chart.yaml --models-dir models/
  shelves-dev chart.yaml --models-dir models/ --port 8089
  shelves-dev dashboard.yaml --chart-dir charts/ --models-dir models/
