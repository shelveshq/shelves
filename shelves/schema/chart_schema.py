...
# 0.15.0: strict keys — every model in the chart grammar forbids extra keys
# (extra="forbid"), so a previously-ignored unknown key (e.g. `colour:`) now
# raises a validation error (SHE-54). Breaking → minor (pre-1.0).
DSL_VERSION = "0.15.0"
